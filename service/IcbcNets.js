...
class IcbcNets {
    ...
    packData(transtype, sendBody, additionBody,msgsender) {
        ...
        sendData.agent = "WECHATAGG";
     
        sendData.imei = 'D62100000002'; 
        ...
        sendData.requestkey = "D6210000000220200320091003";
    ...
    async send(transtype, senddata, additiondata,msgsender="WECHAT") {
        let config={transPort:_config.posp.IcbcPosp.Port, transIp:_config.posp.IcbcPosp.Ip}     
